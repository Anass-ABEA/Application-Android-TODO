package com.thexcoders.mytodo.adapters;
...
import com.thexcoders.mytodo.R;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.todocard, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textTimeAgo.setText(new PrettyTime().format(todo.getDate()));

        holder.btnCheck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                listeners.oncheckChange(todo, position, !todo.isCompleted());
    ...
    private void displaySuitedButtons(ViewHolder holder, Todo todo) {
        if (!isEditMode) {
    ...
    private void checkUncheck(boolean completed, ViewHolder holder) {
        if (completed) {
